...
DEFAULT_RETRIEVAL_MODE = os.getenv("DEFAULT_RETRIEVAL_MODE", "vector")
VECTOR_CANDIDATE_K = int(os.getenv("VECTOR_CANDIDATE_K", "8"))
BM25_CANDIDATE_K = int(os.getenv("BM25_CANDIDATE_K", "8"))
